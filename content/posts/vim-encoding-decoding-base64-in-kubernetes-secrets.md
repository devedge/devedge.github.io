...
This can be extended by setting the `timeoutlen` variable in vim, but be sure to utilize the `ttimeoutlen` variable so pressing ESC does not also use the same delay. [This post](@/posts/eliminating-esc-delays-in-tmux-vim-and-zsh.md) dives into this further.
...
- [Reference StackOverflow post](https://stackoverflow.com/a/7846569)
- [Excellent resource for creating vim mappings](https://alldrops.info/posts/vim-drops/2018-05-15_understand-vim-mappings-and-create-your-own-shortcuts/)
